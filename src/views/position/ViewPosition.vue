...
const addOrUpdateHandle = (id) => {
  console.info("🚀 ~ file:ViewPosition.vue method:addOrUpdateHandle line:149 -----", id)
};
...
const deleteSelectionsHandle=()=>{
  console.info("🚀 ~ file:ViewPosition.vue method:deleteSelectionsHandle line:151 -----", dataListSelections.value)
}
...
const selectionChangeHandle = (val) => {
  // 处理表格选择事件
  console.info("🚀 ~ file:ViewPosition.vue method:selectionChangeHandle line:183 -----", val);
  dataListSelections.value = val;
};

const sizeChangeHandle = (val) => {
  // 处理分页大小变化
  console.info("🚀 ~ file:ViewPosition.vue method:sizeChangeHandle line:189 -----", val)
  pageSize.value = val;
  pageIndex.value = 1;
  getDataList();
};
...
const currentChangeHandle = (val) => {
  // 处理当前页变化
  console.info("🚀 ~ file:ViewPosition.vue method:currentChangeHandle line:197 -----",val )
  pageIndex.value = val;
  getDataList();
};
