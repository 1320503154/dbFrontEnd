<template>
  <div>
    <el-button type="primary" @click="dialog = true">新建职位需求</el-button>
    ...
    >
      <div class="demo-drawer__content">
        <el-form :model="form" :rules="rules" ref="formRef" label-width="120px">
          ...
          <el-form-item label="需求人数" prop="numberRequired">
            <el-input v-model="form.numberRequired" autocomplete="off" />
          </el-form-item>
          <el-form-item label="公司ID" prop="companyId">
            <el-input v-model="form.companyId" autocomplete="off" />
          </el-form-item>
        </el-form>
...
const rules = {
  ...
  numberRequired: [{ required: true, message: '请输入需求人数', trigger: 'blur' }],
