<template>
  <div>
    <el-button text @click="dialog = true">新建公司</el-button>
      ...
      <div class="demo-drawer__content">
        <el-form :model="form" :rules="rules" ref="formRef" label-width="120px">
          ...
          <el-form-item label="公司介绍" prop="companyIntro">
            <el-input v-model="form.companyIntro" type="textarea" />
          </el-form-item>
...
const form = reactive({
  ...
  companyIntro: "龙腾建筑有限公司是一家专业的建筑公司，拥有丰富的建筑经验和雄厚的技术实力。我们致力于为客户提供优质的建筑服务，帮助客户建造梦想家园。",
  contactName: "杨十一",
  ...
  formRef.value.validate((valid) => {
    if (valid) {
      ...
      LHG.post('/api/company/insert', form)
          .then(response => {
            loading.value = false
            console.log("AddCompany::submitForm", response);
            if (response.code === 1) {
              ElMessage({
                message: '操作成功',
                type: 'success',
